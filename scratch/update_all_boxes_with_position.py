...
# -----------------
# BOX 2 (X: 420 to 680, Y: 218 to 312)
# -----------------
# Clear
draw.rectangle([(423, 221), (677, 309)], fill=bg_indigo)
# Draw
draw_centered_text(draw, "■ PROCESS ■", 550, 243, font_sub, color_indigo_500)
draw_centered_text(draw, "2. Collect Organization Details", 550, 258, font_title, color_indigo_950)
draw_centered_text(draw, "Prompts for Org details: Name, Description, Org", 550, 275, font_desc, color_indigo_950)
draw_centered_text(draw, "Email, Org Phone, and Position.", 550, 288, font_desc, color_indigo_950)
...
draw_centered_text(draw, "Prompts for Full Name and personal email", 874, 811, font_desc, color_purple_800)
draw_centered_text(draw, "address (mobile was entered in Step 4).", 874, 824, font_desc, color_purple_800)
...
print("Flowchart updated successfully with position field in Step 2!")
